...
class Course(models.Model):
    ...
    image = models.ImageField(default='', upload_to="courses/%Y/%m", verbose_name=u"封面图", max_length=100,null=True)
    click_nums = models.IntegerField(default=0, verbose_name=u"点击数")
    category = models.CharField(default=u'后端开发', max_length=20, verbose_name=u"课程类别")
    tag = models.CharField(default=u'', max_length=20, verbose_name=u"课程标签")
    need_to_know = models.CharField(default='', max_length=300, verbose_name=u'课程须知')
    what_to_learn = models.CharField(default='', max_length=300, verbose_name=u'学到什么')
...
class Video(models.Model):
    ...
    url = models.URLField(default='', max_length=100, verbose_name=u'访问地址')
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
